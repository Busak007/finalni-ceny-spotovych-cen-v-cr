...
class SpotElectricityConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        schema = vol.Schema({
            ...
            vol.Required(CONF_PRICE_NT, default=0.2693944): float,
            vol.Required(CONF_PRICE_VT, default=2.5689268): float,
            vol.Required(CONF_SPOT_PRICE_ENTITY): str,
            vol.Required(CONF_HDO_ENTITY): str,
            vol.Required(CONF_PRODEJ, default=0.35): float,
            vol.Required(CONF_DAN_Z_ELEKTRINY, default=0.0283): float,
            vol.Required(CONF_CENA_SYSTEMOVYCH_SLUZEB, default=0.17092): float,
            vol.Required(CONF_OZE, default=0.495): float,
